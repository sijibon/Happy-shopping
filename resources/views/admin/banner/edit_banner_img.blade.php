             ...
             <div class="col-8  mt-5">
                <div class="card">
                    <div class="card-header">
                     <span id="addT">Edit banner image</span>
                    </div>   
                        @if ($errors->any())
                        ...
                        @endif
                        <div class="card-body">
                        <form action="{{url('update/banner_image'.$edit_img->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group m-2">
                                <label for="inputEmail4">Banner image</label>
                                <input type="file" name="banner_image" class="form-control">
                                <img style="height: 80px; width:100px" src="{{url($edit_img->banner_image)}}" alt="">
                              </div>
                              <div class="form-group m-2">
                              </div>
